    ...
    <Container maxW={"5xl"} py={12}>
      <SimpleGrid columns={{ base: 1, md: 2 }} spacing={10}>
        <Stack spacing={4}>
          ...
          <Heading>Food for the poor</Heading>
          ...
          >
            <Feature
              ...
              text={"Food spent on starving children"}
            />
            <Feature
              icon={<Icon as={IoLogoBitcoin} color={"green.500"} w={5} h={5} />}
              iconBg={useColorModeValue("green.100", "green.900")}
              text={"Help during a time of famine"}
            />
            <Feature
              icon={
              ...
              text={"Help save a life"}
            />
          </Stack>
          <FormControl>
            <FormLabel>Amount to donate:</FormLabel>
            <Input id="donateamount3" type="text" />
          </FormControl>
          <Stack spacing={10}>
            <Button
              bg={"blue.400"}
