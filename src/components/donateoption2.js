    ...
    <Container maxW={"5xl"} py={12}>
      <SimpleGrid columns={{ base: 1, md: 2 }} spacing={10}>
        <Stack spacing={4}>
          ...
          <Heading>Water for life</Heading>
          <Text color={"gray.500"} fontSize={"lg"}>
            Donate to help build water wells in impoverished villages in Africa.
          </Text>
          <Stack
            spacing={4}
            divider={
          ...
          >
            <Feature
              ...
              text={"Help build water wells for the thirsty"}
            />
            <Feature
              icon={<Icon as={IoLogoBitcoin} color={"green.500"} w={5} h={5} />}
              iconBg={useColorModeValue("green.100", "green.900")}
              text={"Water goes towards drinking and batheing villagers"}
            />
            <Feature
              icon={
              ...
              text={"Water goes towards live-stock and crops"}
            />
          </Stack>
          <FormControl>
            <FormLabel>Amount to donate:</FormLabel>
            <Input id="donateamount2" type="text" />
          </FormControl>
          <Stack spacing={10}>
            <Button
              bg={"blue.400"}
